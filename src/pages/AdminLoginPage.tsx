...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const adminEmail = "sahayasathish60@gmail.com";
    const adminPassword = "Sathish12345";
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, hsl(220 25% 10%), hsl(240 20% 15%), hsl(260 25% 12%))",
      }}
    >
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div
            className="h-18 w-18 rounded-2xl bg-gradient-to-br from-red-500 to-orange-600 flex items-center justify-center mx-auto mb-4 shadow-lg"
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, hsl(220 20% 16%), hsl(220 20% 12%))",
          }}
        >
